...
assert.ok(/opoweb-v88/.test(browserTest));

console.log(`Integridad web v0.81 OK · ${indexAssets.length} referencias · ${cachedAssets.length} recursos PWA · Playwright configurado`);
