...
report.version = 'v0.74.0';
report.date = '2026-07-12';
if (report.summary) report.summary.version = 'v0.74.0';
fs.writeFileSync('audit-v74.json', JSON.stringify(report, null, 2));

assert.equal(report.oposiciones.length, 4);
assert.equal(report.totalQuestions, 2952, `Total inesperado: ${report.totalQuestions}`);
...
assert.equal(uc3m.questions, 540);
console.log('Auditoría de calidad v0.74 OK', JSON.stringify(report.summary));
