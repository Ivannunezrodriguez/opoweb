...
report.version = 'v0.76.0';
report.date = '2026-07-12';
if (report.summary) report.summary.version = 'v0.76.0';
fs.writeFileSync('audit-v76.json', JSON.stringify(report, null, 2));

assert.equal(report.oposiciones.length, 4);
assert.equal(report.totalQuestions, 3012, `Total inesperado: ${report.totalQuestions}`);
...
assert.equal(uc3m.questions, 600);
console.log('Auditoría de calidad v0.76 OK', JSON.stringify(report.summary));
