...
assert.equal(manifest.scripts.at(-1), './assets/js/ui-v83.js');
...
assert.ok(position('./assets/js/uc3m-v80-cierre-calidad.js') < position('./assets/js/ui-v80.js'));
assert.ok(position('./assets/js/ui-v82.js') < position('./assets/js/ui-v83.js'));
...
console.log(`Cargador v0.83 OK · ${manifest.scripts.length} módulos · ${manifest.allAssets.length} recursos · sin duplicados`);
