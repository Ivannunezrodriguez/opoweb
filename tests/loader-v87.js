...
assert.ok(manifest.scripts.length > 120, 'El manifiesto no contiene todos los módulos históricos y teóricos');
...
assert.equal(manifest.scripts.at(-1), './assets/js/ui-v87.js');
...
assert.ok(position('./assets/js/diputacion-test-v87-bloque2.js') < position('./assets/js/puebla-v68.js'));
