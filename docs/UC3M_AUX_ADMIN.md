# UC3M · Auxiliar Administrativo C2 · 2026

## Identificación

- **Administración:** Universidad Carlos III de Madrid.
- **Escala:** Escala Auxiliar Administrativa.
- **Subgrupo:** C2.
- **Sistema:** concurso-oposición, turno libre.
- **Plazas:** 34, con 2 reservadas a personas con discapacidad.
- **Estado personal:** pendiente de solicitud.

## Solicitud y calendario

- Plazo: **9 de julio a 5 de agosto de 2026**, ambos inclusive.
- Presentación exclusivamente telemática.
- Tasa general: **13,83 €**.
- Fecha previsible del ejercicio: **21 de noviembre de 2026 a las 10:00**.
- La fecha debe confirmarse con la resolución definitiva de personas admitidas.

## Examen

- Un ejercicio obligatorio y eliminatorio.
- 70 preguntas + 5 de reserva.
- 4 respuestas alternativas.
- Acierto: +1.
- Error: −1/3.
- Blanco o doble respuesta: 0.
