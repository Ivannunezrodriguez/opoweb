(() => {
  ...
  function progressCard() {
    ...
    const release = window.OPOWEB_CARRANQUE_V69 || {};
    return `<article class="card" id="carranqueV69Card">
      <div class="pill-row"><span class="badge common">Carranque v0.69</span><span class="badge">Temas 1–10</span><span class="badge">Práctico 3–20</span></div>
      ...
      <div class="grid three">
        <div><span class="score">${release.targetThemes || 10}</span><p class="muted">temas con 30 preguntas</p></div>
      ...
      <p><strong>50%</strong> del objetivo mínimo de banco por temas. Estimación global de Carranque: <strong>52%</strong>.</p>
    </article>
    <article class="card compact" id="carranqueNextBlockV69">
  ...
  function testCard() {
    ...
    return `<article class="card compact" id="carranqueTestStatusV69">
